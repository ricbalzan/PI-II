    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            ...
            <div class="top-menu d-flex align-items-center">
                ...
                <div class="dropdown">
                    {{-- <span style="color:forestgreen; position:relative; font-weight:800; left: -350px; ">Usuário tipo: </span> --}}
                    ...
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="{{ asset('img/logo-pjweb.png')}}" alt=""></a>
